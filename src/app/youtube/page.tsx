...
export default function YouTubeInfluencerWorkspace() {
  ...
  const handleGenerateVideo = async () => {
    ...
    // Animate progress bar during the ~60-120s generation
    ...
    info("Veo is rendering...", "Video generation takes 60-120 seconds. Sit tight!");

    // Build a rich visual prompt from the script + scenes
    const scenePrompts = generatedPackage.scenes?.length > 0
    ...
    try {
      ...
      // Convert base64 to blob URL for the video player
